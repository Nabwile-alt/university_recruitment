    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('student', 'Student / Job Seeker'), ('employer', 'Employer'), ('university_staff', 'University Staff'), ('admin', 'Admin')], default='student', max_length=20)),
